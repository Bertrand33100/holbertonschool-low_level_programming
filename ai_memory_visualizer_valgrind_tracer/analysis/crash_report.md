...
## 7. Correction possible (Optionnelle)

Une solution consiste à vérifier que le pointeur retourné par `allocate_numbers()` est différent de `NULL` avant de l'utiliser.
